    ...
    <div className={styles.wrapper}>
      ...
      {!currentUser && (
        <div className="fixed top-6 right-6 z-50">
          <Link
            href="/login"
            className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-4 py-2 rounded-lg backdrop-blur-sm border border-white/20 transition-all duration-200 font-medium text-sm"
          >
      ...
      <section className={styles.panel} aria-label="Choose your interests">
        ...
        {/* Alternative Login Link - Bottom of Panel */}
        {!currentUser && (
          <div className="mt-6 pt-4 border-t border-white/20 text-center">
            ...
            <Link
              href="/login"
              className="inline-flex items-center gap-2 text-amber-300 hover:text-amber-200 font-medium text-sm transition-colors duration-200"
            >
              <LogIn className="w-4 h-4" />
