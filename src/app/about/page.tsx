...
import { FiGithub, FiLinkedin, FiTwitter } from 'react-icons/fi'; // Example icons

// --- Helper Components ---

// NEW: A reusable component for team members for cleaner code.
const TeamMemberCard = ({ name, role, imageUrl, bio, delay, socialLinks }: any) => (
  ...
  const teamMembers = [
    {
      ...
      imageUrl: '/Kyaw.jpeg', // Standardized path
  ...
  return (
    <div>
      ...
      <main className="container page-content">
        <div className="space-y-24"> {/* Increased spacing for more impact */}
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animated-element">
            ...
            <div className="order-1 md:order-2">
                {/* You can place a relevant image here, e.g., a stylized photo of a library or the team brainstorming */}
          ...
          {/* UPDATED: The Technology Section */}
           <section className="text-center animated-element">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
                ...
                <div className="tech-card">
                  ...
                  <p className="tech-card-body">Using <span className="font-semibold text-brand-charcoal">Next.js & React</span>, we built a buttery-smooth interface that feels responsive and alive. No more clunky page reloads—just seamless Browse.</p>
                </div>
                {/* Card 2: Backend */}
                <div className="tech-card">
                  <h3 className="tech-card-title">Intelligent Recommendations</h3>
                  <p className="tech-card-body">Our <span className="font-semibold text-brand-charcoal">Python & Flask</span> backend is the brain of the operation, running the logic that finds books tailored to your interests and needs.</p>
                </div>
                {/* Card 3: Data */}
                <div className="tech-card">
                  <h3 className="tech-card-title">Smart Data Processing</h3>
                  <p className="tech-card-body">We use the <span className="font-semibold text-brand-charcoal">Pandas</span> library to wrangle the library's vast catalog, ensuring the data is clean, accurate, and ready for our recommendation engine.</p>
                </div>
              </div>
          </section>
