...
const TeamMemberCard = ({
  ...
  <div
    className="member-card animated-element"
        ...
        <div className="space-y-24">
          <div className="text-center animated-element">
            ...
            <h1 className="page-title">
              We&apos;re on a Mission to Make the Library Magical.
            </h1>
            <p className="page-subtitle max-w-3xl mx-auto">
              LIBBY BOT is more than just a search bar; it&apos;s a new front
              door to the incredible world of books waiting on our
              university&apos;s shelves.
            </p>
          </div>
          ...
          <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center animated-element">
            <div className="order-2 md:order-1">
              ...
              <div className="space-y-4 text-lg text-brand-muted-grey leading-relaxed">
                ...
                <p>
                  It all started with a simple question: &quot;Why do I spend
                  more time looking for a book than actually reading it?&quot;
                  As students, we felt a disconnect. On one hand, we had access
                  to a treasure trove of physical books. On the other, we lived
                  in a world of instant, personalized digital content.
                </p>
                <p>
                  We imagined a world where the library knew us. Where it could
                  suggest that perfect, obscure philosophy text for our essay or
                  a thrilling novel for a rainy weekend. That vision became
                  LIBBY BOT—our effort to blend the timeless value of the
          ...
          <section className="text-center animated-element">
            ...
            <p className="page-subtitle mt-2 max-w-3xl mx-auto">
              We chose our technology not just because it&apos;s modern, but
              because it creates a better experience for you.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-12 text-left">
              <div className="tech-card">
                <h3 className="tech-card-title">A Lightning-Fast Interface</h3>
                <p className="tech-card-body">
                  Using{" "}
                  <span className="font-semibold text-brand-charcoal">
                    Next.js & React
                  </span>
                  , we built a buttery-smooth interface that feels responsive
                  and alive. No more clunky page reloads—just seamless Browse.
                </p>
              </div>
              <div className="tech-card">
                <h3 className="tech-card-title">Intelligent Recommendations</h3>
                <p className="tech-card-body">
                  Our{" "}
                  <span className="font-semibold text-brand-charcoal">
                    Python & Flask
                  </span>{" "}
                  backend is the brain of the operation, running the logic that
                  finds books tailored to your interests and needs.
                </p>
              </div>
              <div className="tech-card">
                <h3 className="tech-card-title">Smart Data Processing</h3>
                <p className="tech-card-body">
                  We use the{" "}
                  <span className="font-semibold text-brand-charcoal">
                    Pandas
                  </span>{" "}
                  library to wrangle the library&apos;s vast catalog, ensuring
                  the data is clean, accurate, and ready for our recommendation
                  engine.
                </p>
              </div>
            </div>
          ...
          <section>
            <div className="text-center animated-element">
              ...
              <p className="page-subtitle mt-2">
                The curious minds behind the code.
              </p>
            </div>
          ...
          <section className="text-center bg-brand-beige p-12 rounded-lg animated-element">
            ...
            <p className="mt-4 mb-8 text-lg text-brand-muted-grey max-w-2xl mx-auto">
              Our digital shelves are open. Start your journey of discovery and
              see what the library has in store for you.
            </p>
